...
3. **Monthly expenses calculate करें** (post-retirement)।
4. **Inflation factor जोड़ें** – 5–6% annual average।
5. **Corpus required निकालें** – retirement तक कितनी lump sum रकम चाहिए।
6. **Right investment tools चुनें** – PPF, NPS, Mutual Funds, Pension Plans आदि।
