---
title: "9.2 Legal Tax Saving Strategies"
categories: [ Finance, Course ]
tags: [Finance, WealthBuilding, MoneyManagement]
description: "Legal तरीके से Tax कैसे बचाएं"
...
* **Example**: अगर आपकी taxable income ₹10 लाख है और आपने ₹1.5 लाख 80C में invest किया, तो आपकी taxable income ₹8.5 लाख हो जाएगी।
...
* **Limit**:
  ...
  * Parents (< 60): ₹25,000
  * Parents (60+): ₹50,000
* **Tip**: Health insurance लेने से न सिर्फ tax बचता है, बल्कि medical emergencies में financial safety भी मिलती है।
...
* **Bonus**: अगर joint home loan है, तो दोनों borrowers अलग-अलग deduction claim कर सकते हैं।
...
* **Tax evasion** (गलत तरीके से tax न देना) illegal है।
* **Tax planning** (कानून में दिए गए deductions और exemptions का सही इस्तेमाल) legal और smart है।
